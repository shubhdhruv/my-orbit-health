...
const GLP1_STEPS: FormStep[] = [
  ...
  },
  {
    ...
    question: "Have you taken any Weight Loss medication before?",
    subtitle: "Please share details about your previous weight loss medication to help us provide the best care.",
    type: "radio",
    options: [
      { label: "I haven't taken weight loss medications", value: "none" },
      { label: "I am currently taking or have taken weight loss medications", value: "yes" },
    ],
  },
  {
    id: "weight-loss-history-detail",
    question: "Which weight loss medications have you taken?",
    subtitle: "Include names, dosages, and how long you took them",
    type: "textarea",
    placeholder: "e.g., Ozempic 0.5mg for 3 months...",
    conditionalOn: { stepId: "weight-loss-history", value: "yes" },
  },
  {
